...
use restless::clients::{
    gloo::GlooRequest,
    yew::{use_request as use_restless_request, UseRequestHandle},
};
...
#[hook]
pub fn use_request<R: GlooRequest + 'static>(request: R) -> UseRequestHandle<R::Response, R::Error>
where
    R::Response: Clone + 'static,
{
